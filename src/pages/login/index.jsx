...
const Login = () => {
  const getLogin = () => {
    login().then((loginData) => console.log("loginData", loginData));
  };

  const getUser = () => {
    getUserInfo().then((userData) => console.log("userData", userData));
  };
  return (
    <>
      ...
      <Button openType="getUserInfo" onClick={getUser}>
        {" "}
        获取用户信息授权
      </Button>
    </>
